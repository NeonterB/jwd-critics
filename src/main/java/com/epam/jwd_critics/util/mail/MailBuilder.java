...
public class MailBuilder {
    ...
    public String buildMailSubject(String locale) {
        return getLocalizedMessage(locale, MAIL_SUBJECT + "." + mailType.getPropertyName());
    }

    public String buildMailBody(User user, String key, String locale) {
        return String.format(getLocalizedMessage(locale, MAIL_BODY + "." + mailType.getPropertyName()),
