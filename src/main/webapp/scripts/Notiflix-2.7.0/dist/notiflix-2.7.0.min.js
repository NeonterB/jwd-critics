...
(function (t, e) {
    ...
    var e, a, n, i, o, s = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation",
        ...
        l = {
            ...
            t || (t = "60px"), e || (e = "#32c682");
            var a = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"" + e + "\" width=\"" + t + "\" height=\"" + t + "\" preserveAspectRatio=\"xMidYMid\" viewBox=\"0 0 100 100\"><g transform=\"translate(25 50)\"><circle r=\"9\" fill=\"inherit\" transform=\"scale(.239)\"><animateTransform attributeName=\"transform\" begin=\"-0.266s\" calcMode=\"spline\" dur=\"0.8s\" keySplines=\"0.3 0 0.7 1;0.3 0 0.7 1\" keyTimes=\"0;0.5;1\" repeatCount=\"indefinite\" type=\"scale\" values=\"0;1;0\"/></circle></g><g transform=\"translate(50 50)\"><circle r=\"9\" fill=\"inherit\" transform=\"scale(.00152)\"><animateTransform attributeName=\"transform\" begin=\"-0.133s\" calcMode=\"spline\" dur=\"0.8s\" keySplines=\"0.3 0 0.7 1;0.3 0 0.7 1\" keyTimes=\"0;0.5;1\" repeatCount=\"indefinite\" type=\"scale\" values=\"0;1;0\"/></circle></g><g transform=\"translate(75 50)\"><circle r=\"9\" fill=\"inherit\" transform=\"scale(.299)\"><animateTransform attributeName=\"transform\" begin=\"0s\" calcMode=\"spline\" dur=\"0.8s\" keySplines=\"0.3 0 0.7 1;0.3 0 0.7 1\" keyTimes=\"0;0.5;1\" repeatCount=\"indefinite\" type=\"scale\" values=\"0;1;0\"/></circle></g></svg>";
            return a
        }, A = function (t, e) {
            t || (t = "60px"), e || (e = "#32c682");
            ...
            R++, "function" == typeof n && B++, "string" != typeof a && (a = "Notiflix " + s), e.plainText && (a = h(a)), !e.plainText && a.length > e.messageMaxLength && (e = y(!0, e, {
                closeButton: !0,
            ...
            d.id = l.wrapID, d.style.width = e.width, d.style.zIndex = e.zindex, d.style.opacity = e.opacity, "center-center" === e.position ? (d.style.left = e.distance, d.style.top = e.distance, d.style.right = e.distance, d.style.bottom = e.distance, d.style.margin = "auto", d.classList.add("nx-flex-center-center"), d.style.maxHeight = "calc((100vh - " + e.distance + ") - " + e.distance + ")", d.style.display = "flex", d.style.flexWrap = "wrap", d.style.flexDirection = "column", d.style.justifyContent = "center", d.style.alignItems = "center", d.style.pointerEvents = "none") : "center-top" === e.position ? (d.style.left = e.distance, d.style.right = e.distance, d.style.top = e.distance, d.style.bottom = "auto", d.style.margin = "auto") : "center-bottom" === e.position ? (d.style.left = e.distance, d.style.right = e.distance, d.style.bottom = e.distance, d.style.top = "auto", d.style.margin = "auto") : "right-bottom" === e.position ? (d.style.right = e.distance, d.style.bottom = e.distance, d.style.top = "auto", d.style.left = "auto") : "left-top" === e.position ? (d.style.left = e.distance, d.style.top = e.distance, d.style.right = "auto", d.style.bottom = "auto") : "left-bottom" === e.position ? (d.style.left = e.distance, d.style.bottom = e.distance, d.style.top = "auto", d.style.right = "auto") : (d.style.right = e.distance, d.style.top = e.distance, d.style.left = "auto", d.style.bottom = "auto");
            var g;
            e.backOverlay && (g = t.document.createElement("div"), g.id = e.ID + "Overlay", g.style.width = "100%", g.style.height = "100%", g.style.position = "fixed", g.style.zIndex = e.zindex, g.style.left = 0, g.style.top = 0, g.style.right = 0, g.style.bottom = 0, g.style.background = p.backOverlayColor || e.backOverlayColor, g.className = e.cssAnimation ? "with-animation" : "", g.style.animationDuration = e.cssAnimation ? e.cssAnimationDuration + "ms" : "", t.document.getElementById(g.id) ? 0 === B && (t.document.getElementById(g.id).style.background = p.backOverlayColor || e.backOverlayColor) : t.document.body.appendChild(g)), t.document.getElementById(d.id) || t.document.body.appendChild(d);
            var f = t.document.createElement("div");
            f.id = e.ID + "-" + R, f.className = e.className + " " + p.childClassName + " " + (e.cssAnimation ? "with-animation" : "") + " " + (e.useIcon ? "with-icon" : "") + " nx-" + e.cssAnimationStyle + " " + (e.closeButton && "function" != typeof n ? "with-close-button" : "") + " " + ("function" == typeof n ? "with-callback" : "") + " " + (e.clickToClose ? "click-to-close" : ""), f.style.fontSize = e.fontSize, f.style.color = p.textColor, f.style.background = p.background, f.style.borderRadius = e.borderRadius, f.style.pointerEvents = "all", e.rtl && (f.setAttribute("dir", "rtl"), f.classList.add("rtl-on")), f.style.fontFamily = "\"" + e.fontFamily + "\", " + r, e.cssAnimation && (f.style.animationDuration = e.cssAnimationDuration + "ms");
            var u = "";
            ...
            if (w) {
                ...
                if (("function" == typeof n || e.clickToClose) && w.addEventListener("click", function () {
                    "function" == typeof n && (B--, n()), S();
                    var t = setTimeout(function () {
                        I(), clearTimeout(t)
                    }, e.cssAnimationDuration)
                    ...
                    var M = function () {
                        C = setTimeout(function () {
                            S()
                        }, e.timeout), z = setTimeout(function () {
                            I()
                        }, e.timeout + e.cssAnimationDuration)
                    };
                    M(), e.pauseOnHover && (w.addEventListener("mouseenter", function () {
                        w.classList.add("nx-paused"), clearTimeout(C), clearTimeout(z)
                    }), w.addEventListener("mouseleave", function () {
                        w.classList.remove("nx-paused"), M()
                    }))
                }
            }
            if (e.showOnlyTheLastOne && 0 < R) for (var A, X = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + R + "])"), F = 0; F < X.length; F++) A = X[F], null !== A.parentNode && A.parentNode.removeChild(A);
            e = y(!0, e, c)
            ...
            var d = a[l.toLocaleLowerCase("en")];
            ...
            g.id = c.ID, g.className = a.className, g.style.zIndex = a.zindex, g.style.borderRadius = a.borderRadius, g.style.fontFamily = "\"" + a.fontFamily + "\", " + r, a.rtl && (g.setAttribute("dir", "rtl"), g.classList.add("rtl-on")), g.style.display = "flex", g.style.flexWrap = "wrap", g.style.flexDirection = "column", g.style.alignItems = "center", g.style.justifyContent = "center";
            var f = "";
            a.backOverlay && (f = "<div class=\"" + a.className + "-overlay" + (a.cssAnimation ? " with-animation" : "") + "\" style=\"background:" + (d.backOverlayColor || a.backOverlayColor) + ";animation-duration:" + a.cssAnimationDuration + "ms;\"></div>");
            var u = "";
            if ("Success" === l ? u = w(a.svgSize, d.svgColor) : "Failure" === l ? u = v(a.svgSize, d.svgColor) : "Warning" === l ? u = N(a.svgSize, d.svgColor) : "Info" == l && (u = C(a.svgSize, d.svgColor)), g.innerHTML = f + "<div class=\"" + a.className + "-content" + (a.cssAnimation ? " with-animation " : "") + " nx-" + a.cssAnimationStyle + "\" style=\"width:" + a.width + "; background:" + a.backgroundColor + "; animation-duration:" + a.cssAnimationDuration + "ms;\"><div style=\"width:" + a.svgSize + "; height:" + a.svgSize + ";\" class=\"" + a.className + "-icon\">" + u + "</div><h5 class=\"" + a.className + "-title\" style=\"font-weight:500; font-size:" + a.titleFontSize + "; color:" + d.titleColor + ";\">" + e + "</h5><p class=\"" + a.className + "-message\" style=\"font-size:" + a.messageFontSize + "; color:" + d.messageColor + ";\">" + n + "</p><a id=\"NXReportButton\" class=\"" + a.className + "-button\" style=\"font-weight:500; font-size:" + a.buttonFontSize + "; background:" + d.buttonBackground + "; color:" + d.buttonColor + ";\">" + i + "</a></div>", !t.document.getElementById(g.id)) {
                t.document.body.appendChild(g);
                var b = t.document.getElementById(g.id), k = t.document.getElementById("NXReportButton");
                k.addEventListener("click", function () {
                    "function" == typeof o && o(), b.classList.add("remove");
                    var t = setTimeout(function () {
            ...
            a = y(!0, a, m)
        }, D = function (e, a, i, o, s, l, c, p, d) {
            if (!x("body")) return !1;
            n || j.Confirm.Init({});
            var g = y(!0, n, {});
            "object" != typeof c || Array.isArray(c) || (n = y(!0, n, c)), "string" != typeof e && (e = "Notiflix Confirm"), "string" != typeof a && (a = "Do you agree with me?"), "string" != typeof i && (i = "Yes"), "string" != typeof o && (o = "No"), "function" != typeof s && (s = void 0), "function" != typeof l && (l = void 0), n.plainText && (e = h(e), a = h(a), i = h(i), o = h(o)), n.plainText || (e.length > n.titleMaxLength && (e = "HTML Tags Error", a = "Your Title content length is more than \"titleMaxLength\" option.", i = "Okay", o = "..."), a.length > n.messageMaxLength && (e = "HTML Tags Error", a = "Your Message content length is more than \"messageMaxLength\" option.", i = "Okay", o = "..."), (i.length || o.length) > n.buttonsMaxLength && (e = "HTML Tags Error", a = "Your Buttons contents length is more than \"buttonsMaxLength\" option.", i = "Okay", o = "...")), e.length > n.titleMaxLength && (e = e.substring(0, n.titleMaxLength) + "..."), a.length > n.messageMaxLength && (a = a.substring(0, n.messageMaxLength) + "..."), i.length > n.buttonsMaxLength && (i = i.substring(0, n.buttonsMaxLength) + "..."), o.length > n.buttonsMaxLength && (o = o.substring(0, n.buttonsMaxLength) + "..."), n.cssAnimation || (n.cssAnimationDuration = 0);
            var f = t.document.createElement("div");
            f.id = m.ID, f.className = n.className + (n.cssAnimation ? " with-animation nx-" + n.cssAnimationStyle : ""), f.style.zIndex = n.zindex, f.style.padding = n.distance, n.rtl && (f.setAttribute("dir", "rtl"), f.classList.add("rtl-on"));
            var u = "string" == typeof n.position ? n.position.trim() : "center";
            f.classList.add("nx-position-" + u), f.style.fontFamily = "\"" + n.fontFamily + "\", " + r;
            var b = "";
            n.backOverlay && (b = "<div class=\"" + n.className + "-overlay" + (n.cssAnimation ? " with-animation" : "") + "\" style=\"background:" + n.backOverlayColor + ";animation-duration:" + n.cssAnimationDuration + "ms;\"></div>");
            var k = "";
            "function" == typeof s && (k = "<a id=\"NXConfirmButtonCancel\" class=\"confirm-button-cancel\" style=\"color:" + n.cancelButtonColor + ";background:" + n.cancelButtonBackground + ";font-size:" + n.buttonsFontSize + ";\">" + o + "</a>");
            var w = "", v = !1;
            if (p && "string" == typeof d && 0 < d.length && (v = d, w = "<div><input id=\"NXConfirmValidationInput\" type=\"text\" style=\"font-size:" + n.messageFontSize + ";border-radius: " + n.borderRadius + ";\" maxlength=\"" + d.length + "\" autocomplete=\"off\" spellcheck=\"false\" autocapitalize=\"none\" /></div>"), f.innerHTML = b + "<div class=\"" + n.className + "-content\" style=\"width:" + n.width + "; background:" + n.backgroundColor + "; animation-duration:" + n.cssAnimationDuration + "ms; border-radius: " + n.borderRadius + ";\"><div class=\"" + n.className + "-head\"><h5 style=\"color:" + n.titleColor + ";font-size:" + n.titleFontSize + ";\">" + e + "</h5><div style=\"color:" + n.messageColor + ";font-size:" + n.messageFontSize + ";\">" + a + w + "</div></div><div class=\"" + n.className + "-buttons\"><a id=\"NXConfirmButtonOk\" class=\"confirm-button-ok" + ("function" == typeof s ? "" : " full") + "\" style=\"color:" + n.okButtonColor + ";background:" + n.okButtonBackground + ";font-size:" + n.buttonsFontSize + ";\">" + i + "</a>" + k + "</div></div>", !t.document.getElementById(f.id)) {
                t.document.body.appendChild(f);
                var N = t.document.getElementById(f.id), C = t.document.getElementById("NXConfirmButtonOk"),
                    z = t.document.getElementById("NXConfirmValidationInput");
                if (z && (z.focus(), z.addEventListener("keyup", function (t) {
                    var e = (t.target.value || "").toString();
                    if (e !== v) z.classList.add("nx-validation-failure"), z.classList.remove("nx-validation-success"); else {
                        z.classList.remove("nx-validation-failure"), z.classList.add("nx-validation-success");
                        var a = "enter" === (t.key || "").toLocaleLowerCase("en") || 13 === t.keyCode;
                        a && C.dispatchEvent(new Event("click"))
                    }
                })), C.addEventListener("click", function (t) {
                    if (p && v && z) {
                        var e = (z.value || "").toString();
                        if (e !== v) return z.focus(), z.classList.add("nx-validation-failure"), t.stopPropagation(), t.preventDefault(), t.returnValue = !1, t.cancelBubble = !0, !1;
                        z.classList.remove("nx-validation-failure")
                    }
                    "function" == typeof s && s(), N.classList.add("remove");
                    var a = setTimeout(function () {
                        null !== N.parentNode && (N.parentNode.removeChild(N), clearTimeout(a))
            ...
            i || j.Loading.Init({});
            var l = y(!0, i, {});
            if ("object" == typeof e && !Array.isArray(e) || "object" == typeof a && !Array.isArray(a)) {
                var c = {};
                "object" == typeof e ? c = e : "object" == typeof a && (c = a), i = y(!0, i, c)
            }
            var m = "";
            if ("string" == typeof e && 0 < e.length && (m = e), o) {
                ...
                var d = "";
                0 < m.length && (d = "<p id=\"" + i.messageID + "\" class=\"loading-message\" style=\"color:" + i.messageColor + ";font-size:" + i.messageFontSize + ";\">" + m + "</p>"), i.cssAnimation || (i.cssAnimationDuration = 0);
                var f = "";
                if ("standard" === n) f = z(i.svgSize, i.svgColor); else if ("hourglass" === n) f = S(i.svgSize, i.svgColor); else if ("circle" === n) f = I(i.svgSize, i.svgColor); else if ("arrows" === n) f = L(i.svgSize, i.svgColor); else if ("dots" === n) f = M(i.svgSize, i.svgColor); else if ("pulse" === n) f = A(i.svgSize, i.svgColor); else if ("custom" === n && null !== i.customSvgUrl) f = "<img class=\"custom-loading-icon\" width=\"" + i.svgSize + "\" height=\"" + i.svgSize + "\" src=\"" + i.customSvgUrl + "\" alt=\"Notiflix\">"; else {
                    if ("custom" === n && null == i.customSvgUrl) return g("Notiflix Error", "You have to set a static SVG url to \"customSvgUrl\" option to use Loading Custom."), !1;
                    "notiflix" === n && (f = X(i.svgSize, "#f8f8f8", "#32c682"))
                }
                var u = parseInt((i.svgSize || "").replace(/[^0-9]/g, "")), b = t.innerWidth,
                    k = u >= b ? b - 40 + "px" : u + "px",
                    w = "<div style=\"width:" + k + "; height:" + k + ";\" class=\"" + i.className + "-icon" + (0 < m.length ? " with-message" : "") + "\">" + f + "</div>",
                    v = t.document.createElement("div");
                if (v.id = p.ID, v.className = i.className + (i.cssAnimation ? " with-animation" : "") + (i.clickToClose ? " click-to-close" : ""), v.style.zIndex = i.zindex, v.style.background = i.backgroundColor, v.style.animationDuration = i.cssAnimationDuration + "ms", v.style.fontFamily = "\"" + i.fontFamily + "\", " + r, v.style.display = "flex", v.style.flexWrap = "wrap", v.style.flexDirection = "column", v.style.alignItems = "center", v.style.justifyContent = "center", i.rtl && (v.setAttribute("dir", "rtl"), v.classList.add("rtl-on")), v.innerHTML = w + d, !t.document.getElementById(v.id) && (t.document.body.appendChild(v), i.clickToClose)) {
                    var N = t.document.getElementById(v.id);
                    N.addEventListener("click", function () {
                        v.classList.add("remove");
                        var t = setTimeout(function () {
                            null !== v.parentNode && (v.parentNode.removeChild(v), clearTimeout(t))
            ...
            } else g("Notiflix Error", "Where is the new message?")
        }, W = 0, H = function (e, a, n, s, l, c) {
            var m = "string" != typeof a || 1 > (a || "").length || 1 === (a || "").length && ("#" === (a || "")[0] || "." === (a || "")[0]);
            if (m) return g("Notiflix Error", "The selector parameter must be a String and matches a specified CSS selector(s)."), !1;
            var p = t.document.querySelectorAll(a);
            if (1 > p.length) return g("Notiflix Error", "You called the \"Notiflix.Block...\" function with \"" + a + "\" selector, but there is no such element(s) in the document."), !1;
            o || j.Block.Init({});
            var u = y(!0, o, {});
            if ("object" == typeof s && !Array.isArray(s) || "object" == typeof l && !Array.isArray(l)) {
                var b = {};
                "object" == typeof s ? b = s : "object" == typeof l && (b = l), o = y(!0, o, b)
            }
            var k = "";
            "string" == typeof s && 0 < s.length && (k = s), o.cssAnimation || (o.cssAnimationDuration = 0);
            var w = "notiflix-block";
            "string" == typeof o.className && (w = o.className.trim());
            var v = "number" == typeof o.querySelectorLimit ? o.querySelectorLimit : 200, N = p.length >= v ? v : p.length;
            if (e) for (var C = 0; C < N; C++) {
                var X = p[C], R = X.querySelectorAll("[id^=" + d.ID + "]");
                if (1 > R.length) {
                    var B = "";
                    n && ("hourglass" === n ? B = S(o.svgSize, o.svgColor) : "circle" === n ? B = I(o.svgSize, o.svgColor) : "arrows" === n ? B = L(o.svgSize, o.svgColor) : "dots" === n ? B = M(o.svgSize, o.svgColor) : "pulse" === n ? B = A(o.svgSize, o.svgColor) : B = z(o.svgSize, o.svgColor));
                    var F = "<span class=\"" + w + "-icon\" style=\"width:" + o.svgSize + ";height:" + o.svgSize + ";\">" + B + "</span>",
                        E = "";
                    0 < k.length && (k = k.length > o.messageMaxLength ? h(k).substring(0, o.messageMaxLength) + "..." : h(k), E = "<span style=\"font-size:" + o.messageFontSize + ";color:" + o.messageColor + ";\" class=\"" + w + "-message\">" + k + "</span>"), W++;
                    var D = t.document.createElement("div");
                    D.id = d.ID + "-" + W, D.className = w + "-wrap" + (o.cssAnimation ? " with-animation" : ""), D.style.position = o.position, D.style.zIndex = o.zindex, D.style.background = o.backgroundColor, D.style.animationDuration = o.cssAnimationDuration + "ms", D.style.fontFamily = "\"" + o.fontFamily + "\", " + r, D.style.display = "flex", D.style.flexWrap = "wrap", D.style.flexDirection = "column", D.style.alignItems = "center", D.style.justifyContent = "center", o.rtl && (D.setAttribute("dir", "rtl"), D.classList.add("rtl-on")), D.innerHTML = F + E;
                    var T = t.getComputedStyle(X).getPropertyValue("position"),
                        O = "string" == typeof T ? T.toLocaleLowerCase("en") : "relative",
                        H = Math.round(1.25 * parseInt(o.svgSize)) + 40, P = X.offsetHeight || 0, Q = "";
                    H > P && (Q = "min-height:" + H + "px;");
                    var Y = "";
                    Y = X.getAttribute("id") ? "#" + X.getAttribute("id") : X.classList[0] ? "." + X.classList[0] : (X.tagName || "").toLocaleLowerCase("en");
                    var G = "", V = -1 >= ["absolute", "relative", "fixed", "sticky"].indexOf(O);
                    if (V || 0 < Q.length) {
                        if (!x("head")) return !1;
                        V && (G = "position:relative!important;");
                        var q = "<style id=\"Style-" + d.ID + "-" + W + "\">" + Y + "." + w + "-position{" + G + Q + "}</style>",
                            U = t.document.createRange();
                        U.selectNode(t.document.head);
                        var K = U.createContextualFragment(q);
                        t.document.head.appendChild(K), X.classList.add(w + "-position")
                    }
                    X.appendChild(D)
                }
            } else var J = function (e) {
                var a = setTimeout(function () {
                ...
                if (t && 0 < t.length) for (var e, n = 0; n < t.length; n++) e = t[n], e && (e.classList.add("remove"), J(e)); else f("Notiflix Info", "\"Notiflix.Block.Remove();\" function called with \"" + a + "\" selector, but this selector does not have a \"Notiflix.Block...\" element to remove.")
            }, $ = function (t) {
                ...
                for (var t, e = 0; e < N; e++) t = p[e], $(t), R = t.querySelectorAll("[id^=" + d.ID + "]"), Z(R);
                clearTimeout(_)
            }, c);
            o = y(!0, o, u)
        }, j = {
            Notify: {
                Init: function (t) {
                    ...
                    return e ? void (e = y(!0, e, t)) : (g("Notiflix Error", "You have to initialize the Notify module before call Merge function."), !1)
                ...
                Init: function (t) {
                    ...
                    return a ? void (a = y(!0, a, t)) : (g("Notiflix Error", "You have to initialize the Report module before call Merge function."), !1)
                ...
                Init: function (t) {
                    ...
                    return n ? void (n = y(!0, n, t)) : (g("Notiflix Error", "You have to initialize the Confirm module before call Merge function."), !1)
                ...
                Init: function (t) {
                    ...
                    return i ? void (i = y(!0, i, t)) : (g("Notiflix Error", "You have to initialize the Loading module before call Merge function."), !1)
                    ...
                    "number" != typeof t && (t = 0), T(!1, !1, !1, !1, t)
                }, Change: function (t) {
                    O(t)
                }
            }, Block: {
                Init: function (t) {
                    o = y(!0, d, t), k(o.useGoogleFont, o.fontFamily), b()
                }, Merge: function (t) {
                    return o ? void (o = y(!0, o, t)) : (g("Notiflix Error", "You have to initialize the \"Notiflix.Block\" module before call Merge function."), !1)
                    ...
                    "number" != typeof e && (e = 0), H(!1, t, !1, !1, !1, e)
                }
            }
        };
