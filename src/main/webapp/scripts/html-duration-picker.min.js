    ...
    return function (t) {
        ...
        r.r(e),
            ...
            var t = ".pickerStyles {  text-align: right;  padding-right: 20px;  box-sizing: border-box;  width: 100%;  margin: 0;  cursor: text;}.scrollStyle {  text-align: center;  width: 16px;  padding: 0 4px;  border: none;  cursor: default;  position: absolute;}.caretStyle {  width: 0;  height: 0;  border-style: solid;}.caretUpStyle {  border-width: 0 4px 5px 4px;  border-color: transparent transparent #000 transparent;}.caretDownStyle {  border-width: 5px 4px 0 4px;  border-color: #000 transparent transparent transparent;}.controlsDivStyle {  display: inline-block;  position: absolute;  top: 1px;  padding: 2px 0;}.controlWrapperStyle {  display: inline-block;  position: relative;  background: transparent;  padding: 0;}",
                e = function (t, e) {
                    var r, n = t.target, a = n.selectionStart, o = n.value, i = o.indexOf(":"), u = o.lastIndexOf(":");
                    ...
                    var r = n(t.target), a = e(t, r), o = a.cursorSelection, i = a.hourMarker, u = a.minuteMarker;
                    if (o) {
                    ...
                    e %= 3600;
                    var a = Math.floor(e / 60), o = e % 60, i = String(r).padStart(2, "0"), u = String(a).padStart(2, "0"),
                        s = String(o).padStart(2, "0"), d = "".concat(i, ":").concat(u);
                    ...
                    var r = t.value.indexOf(":"), a = t.value.lastIndexOf(":"), o = n(t);
                    ...
                    var r = m(t), n = r.maxDuration, a = r.minDuration;
                    return Math.min(Math.max(e, a), n)
                }, p = function (t) {
                    var e = t.split(":");
                    return e.length < 2 ? 0 : Number(e[2] || 0) + Number(60 * e[1]) + Number(60 * e[0] * 60)
                }, f = function (t) {
                    var r = n(t.target), a = e(t, r).cursorSelection, o = t.target.value.split(":");
                    t.target.dataset.duration && c(t.target.dataset.duration, r) && (r && 2 !== o.length || !r && 3 !== o.length) ? u(t.target, t.target.dataset.duration) : r || 3 === o.length ? r && 2 !== o.length ? u(t.target, "00:00") : (isNaN(o[0]) && (o[0] = "00"), (isNaN(o[1]) || o[1] < 0) && (o[1] = "00"), (o[1] > 59 || o[1].length > 2) && (o[1] = "59"), r || 2 !== o[1].length || o[1].slice(-1) !== t.key || "minutes" !== a || d(t.target, "right"), r || ((isNaN(o[2]) || o[2] < 0) && (o[2] = "00"), (o[2] > 59 || o[2].length > 2) && (o[2] = "59")), u(t.target, o.join(":"))) : u(t.target, "00:00:00")
                }, g = function (t) {
                    var e = t.target, r = e.value || e.dataset.duration, n = p(r);
                    a(e, l(e, n))
                }, v = function (t) {
                    ...
                    if ("Tab" === t.key) {
                        var e = i(t.target), r = n(t.target) ? 3600 : 60, a = t.shiftKey ? "left" : "right";
                        d(t.target, a), ("left" === a && e < 3600 || "right" === a && e >= r) && t.preventDefault()
                    }
                    if (isNaN(t.key) && !["Backspace", "ArrowDown", "ArrowUp", "Tab"].includes(t.key)) return t.preventDefault(), !1
                }, b = function (t, e, r) {
                    var a = t.dataset[e];
                    return c(a, n(t)) ? p(a) : r
                }, m = function (t) {
                    return {minDuration: b(t, "durationMin", 0), maxDuration: b(t, "durationMax", 1 / 0)}
                }, h = function (e) {
                    if (e) {
                        var u = document.head || document.getElementsByTagName("head")[0],
                            d = document.createElement("style");
                        u.appendChild(d), d.styleSheet ? d.styleSheet.cssText = t : d.appendChild(document.createTextNode(t))
                    }
                    return document.querySelectorAll("input.html-duration-picker").forEach((function (t) {
                        if ("true" != t.getAttribute("data-upgraded")) {
                            var e = t.currentStyle || window.getComputedStyle(t), u = e.marginRight, d = e.marginLeft,
                                p = e.width;
                            t.setAttribute("data-upgraded", !0), t.value && c(t.value, n(t)) || a(t, function (t) {
                                var e = b(t, "duration", 0);
                                return l(t, e)
                            }(t)), t.classList.add("pickerStyles"), t.setAttribute("aria-label", "Duration Picker"), t.addEventListener("keydown", v), t.addEventListener("focus", r), t.addEventListener("mouseup", r), t.addEventListener("change", f), t.addEventListener("blur", g), t.addEventListener("keyup", f), t.addEventListener("drop", (function (t) {
                                return t.preventDefault()
                            }));
                            var m = document.createElement("button"), h = document.createElement("button"), y = [m, h];
                            ...
                            var S = document.createElement("div"), w = document.createElement("div");
                            S.setAttribute("class", "caretStyle caretUpStyle"), w.setAttribute("class", "caretStyle caretDownStyle"), h.appendChild(w), m.appendChild(S), y.forEach((function (e) {
                                ...
                                e.addEventListener("mousedown", (function (n) {
                                    n.target.style.transform = "translateY(1px)", n.preventDefault(), e == m ? (s(t, "up"), r = setInterval(s, 200, t, "up")) : (s(t, "down"), r = setInterval(s, 200, t, "down"))
                                })), e.addEventListener("keypress", (function (r) {
                                    r.target.style.transform = "translateY(1px)", "Enter" == r.key && (r.preventDefault(), s(t, e == m ? "up" : "down"))
                            ...
                            x.setAttribute("class", "controlsDivStyle"), x.setAttribute("style", "left: ".concat(parseFloat(p) - 20, "px; height:").concat(t.offsetHeight, "px;")), x.classList.add("controls"), x.appendChild(m), x.appendChild(h);
                            var E = document.createElement("div");
                            E.setAttribute("class", "controlWrapperStyle"), E.setAttribute("style", "width: ".concat(p, "; margin-left: ").concat(d, "; margin-right: ").concat(u, ";")), E.classList.add("html-duration-picker-wrapper"), t.parentNode.insertBefore(E, t), E.appendChild(t), E.appendChild(x)
                        }
                    })), !0
                };
